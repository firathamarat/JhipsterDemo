...
public class BookResourceIntTest {
    ...
    private static final LocalDate DEFAULT_PUBLICAITON_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_PUBLICAITON_DATE = LocalDate.now(ZoneId.systemDefault());
     ...
     *
     * @see com.jhipster.demo.repository.search.BookSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book()
            ...
            .publicaitonDate(DEFAULT_PUBLICAITON_DATE)
            .price(DEFAULT_PRICE);
        return book;
    }
    ...
    public void createBook() throws Exception {
        ...
        assertThat(testBook.getPublicaitonDate()).isEqualTo(DEFAULT_PUBLICAITON_DATE);
    ...
    @Test
    @Transactional
    public void checkPublicaitonDateIsRequired() throws Exception {
        int databaseSizeBeforeTest = bookRepository.findAll().size();
        // set the field null
        book.setPublicaitonDate(null);
    ...
    public void getAllBooks() throws Exception {
        ...
        restBookMockMvc.perform(get("/api/books?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].publicaitonDate").value(hasItem(DEFAULT_PUBLICAITON_DATE.toString())))
    ...
    public void getBook() throws Exception {
        ...
        restBookMockMvc.perform(get("/api/books/{id}", book.getId()))
            ...
            .andExpect(jsonPath("$.publicaitonDate").value(DEFAULT_PUBLICAITON_DATE.toString()))
    ...
    public void updateBook() throws Exception {
        ...
        updatedBook
            ...
            .publicaitonDate(UPDATED_PUBLICAITON_DATE)
            .price(UPDATED_PRICE);
        ...
        assertThat(testBook.getPublicaitonDate()).isEqualTo(UPDATED_PUBLICAITON_DATE);
